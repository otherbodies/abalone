...
## cluster analysis and model fits

Hierarchical clustering - based on furthest months. Text labels refer to which model (furthest month method) fitted best.

<img src="cluster_fur.png">

Hierarchical clustering - based on furthest months. Text labels refer to which model (old - distance based method) fitted best.

<img src="cluster_fur_labels_oldmethod.png">

Only participants who did both rounds (10/10)

<img src="cluster_fur_didall.png">

CLustering based on mixed fit (furthest for some and regression for others). Text labels refer to which model (old - distance based method) fitted best.

<img src="cluster_mixed_fit.png">
...
t-tests for 10/10 syn vs controls
